// Earthquake data
var EQdata = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_month.geojson";

// Plate Techtonics data
var PTdata = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_plates.json";
...
var myMap = L.map("map", {
    center: [ 37.09, -95.71 ],
    zoom: 5,
    layers: [satellite]     //default selected layer
    });
...
d3.json(PTdata, function(PTdata) {

  PTdata.features.forEach(function(feature) {console.log(feature.properties.Code)});

  L.geoJson(PTdata.features, {style: style}).addTo(techtonicplates);
